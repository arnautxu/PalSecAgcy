...
const ES: Record<CommercialId, PageCopy> = {
  "web-design": {
    ...
    proofTitle: "Webs e interfaces en nuestro portfolio",
    proofIntro: "Weboteca reúne cinco webs publicadas con vistas de escritorio y móvil. VIRA y Galeón muestran, además, nuestro trabajo en experiencia de usuario e interfaces de aplicaciones; cada caso documenta un alcance distinto.",
    relatedProjects: [{ slug: "weboteca", note: "Cinco webs publicadas que puedes explorar y visitar en directo." }, { slug: "vira", note: "Diseño de una aplicación para adolescentes con TDAH." }, { slug: "galeon", note: "Aplicación interactiva para explorar las Colecciones Reales." }],
  ...
  "web-development": {
    ...
    proofTitle: "Webs publicadas y experiencia digital",
    proofIntro: "Weboteca permite visitar cinco webs publicadas y comparar sus versiones de escritorio y móvil. VIRA y Galeón documentan trabajo de interfaz; el alcance de desarrollo de cada nuevo proyecto se define en la propuesta.",
    relatedProjects: [{ slug: "weboteca", note: "Cinco webs publicadas con enlaces a sus versiones en directo." }, { slug: "vira", note: "Experiencia e interfaz de una aplicación." }, { slug: "galeon", note: "Navegación y contenido en una aplicación interactiva." }],
...
const CA: Record<CommercialId, PageCopy> = {
  "web-design": {
    ...
    proofTitle: "Webs i interfícies al nostre portafolis",
    proofIntro: "Weboteca reuneix cinc webs publicades amb vistes d'escriptori i mòbil. VIRA i Galeón mostren, a més, la nostra feina en experiència d'usuari i interfícies d'aplicacions; cada cas documenta un abast diferent.",
    relatedProjects: [{ slug: "weboteca", note: "Cinc webs publicades que pots explorar i visitar en directe." }, { slug: "vira", note: "Disseny d'una aplicació per a adolescents amb TDAH." }, { slug: "galeon", note: "Aplicació interactiva per explorar les Col·leccions Reials." }],
  ...
  "web-development": {
    ...
    proofTitle: "Webs publicades i experiència digital",
    proofIntro: "Weboteca permet visitar cinc webs publicades i comparar-ne les versions d'escriptori i mòbil. VIRA i Galeón documenten feina d'interfície; l'abast de desenvolupament de cada nou projecte es defineix a la proposta.",
    relatedProjects: [{ slug: "weboteca", note: "Cinc webs publicades amb enllaços a les versions en directe." }, { slug: "vira", note: "Experiència i interfície d'una aplicació." }, { slug: "galeon", note: "Navegació i contingut en una aplicació interactiva." }],
...
const EN: Record<CommercialId, PageCopy> = {
  "web-design": {
    ...
    proofTitle: "Websites and interfaces in our portfolio",
    proofIntro: "Weboteca brings together five live websites with desktop and mobile views. VIRA and Galeón also show our work on user experience and application interfaces; each case documents a different scope.",
    relatedProjects: [{ slug: "weboteca", note: "Five live websites to explore and visit." }, { slug: "vira", note: "Application design for teenagers with ADHD." }, { slug: "galeon", note: "An interactive application for exploring the Royal Collections." }],
  ...
  "web-development": {
    ...
    proofTitle: "Live websites and digital experience",
    proofIntro: "Weboteca links to five live websites and shows their desktop and mobile views. VIRA and Galeón document interface work; the development scope for each new project is defined in its proposal.",
    relatedProjects: [{ slug: "weboteca", note: "Five published websites with links to their live versions." }, { slug: "vira", note: "Application experience and interface design." }, { slug: "galeon", note: "Navigation and content in an interactive application." }],
